                                ...
                                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="package.html#trending-package">Trending Packages</a></li>
                                            <li><a class="dropdown-item" href="package.html#oneday-package">One Day Packages</a></li>
                                            <li><a class="dropdown-item" href="package.html#weekend-package">Weekend Packages</a></li>
                                            <li><a class="dropdown-item" href="package.html#customized-package">Customized Package</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link secondary"  href="myaccount.html"><i class="fa-solid fa-user"></i></a>
                                    </li>
                                    ...
                                    <li class="nav-item btn-none">
                                        <a class="nav-link login primary" href="login.html">Login</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
