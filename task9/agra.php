    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                <div class="agra-banner banner-box">
                    <div class="mask"></div>
                    <div class="row justify-content-center">
                        <div class="col-sm-7 col-lg-8 banner-content">
                            <h1 data-aos="zoom-in" data-aos-delay="150" data-aos-duration="1000">AGRA</h1>
                        </div>
                    </div>
                </div>
            </section>

            <section class="agra-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Agra</h1>
                                <div>
                                    <h4 class="pb-2">₹15,500 / <small>person</small></h4>
                                    <h6>Duration: 6 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>Agra, located in the northern state of Uttar Pradesh, India, is a city steeped in
                                history and rich cultural heritage. It is most famous for housing one of the Seven
                                Wonders of the World, the Taj Mahal. An Agra tour offers visitors a chance to explore
                                magnificent Mughal architecture, vibrant local markets, and historical monuments.
                        ...
                        <div class="row ">
                            <div class="col text-start pt-5">
                                <a href="destination.html"><button type="button" class="btn theme-btn"><i
