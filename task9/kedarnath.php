    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                <div class="kedarnath-banner banner-box">
                    <div class="mask"></div>
                    <div class="row justify-content-center">
                        <div class="col-sm-7 col-lg-8 banner-content">
                            <h1  data-aos="zoom-in" data-aos-delay="150"
                            data-aos-duration="1000">KEDARNATH</h1>
                        </div>
                    </div>
                </div>
            </section>

            <section class="kedarnath-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Kedarnath</h1>
                                <div>
                                    <h4 class="pb-2">25,500 / <small>person</small></h4>
                                    <h6>Duration: 10 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>Kedarnath is a sacred and picturesque destination nestled in the Himalayas of Uttarakhand, India. It is one of the Char Dhams and is renowned for its ancient Shiva temple, stunning natural beauty, and spiritual significance. Here's a detailed description of a tour to Kedarnath:
